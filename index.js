...
rmDeviceTypes[parseInt(0x62bc, 16)] = 'Broadlink RM 4 Mini';
...
class Device {
  ...
  constructor (host, macAddress, deviceType, port) {
    ...
    this.request_header = parseInt(deviceType, 16) === parseInt(0x62bc, 16) ? new Buffer([0x04, 0x00]) : new Buffer([]);
    this.code_sending_header = parseInt(deviceType, 16) === parseInt(0x62bc, 16) ? new Buffer([0xd0, 0x00]) : new Buffer([]);
